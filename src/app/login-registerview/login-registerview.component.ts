...
export class LoginRegisterviewComponent implements OnInit {
  ...
  OnFormSubmitted(){
    ...
    this.Register(email, pwd, username, gender, type1, type2, house);
  }

  
  Register(email: string, pwd: string, username: string, gender: string,
            type1: string, type2: string, house: string) {
